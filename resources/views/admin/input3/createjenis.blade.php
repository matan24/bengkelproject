...
@section('title', 'Input Jenis Service | Bengkel Mobil')
            ...
            <main id="main">
                ...
                <section id="breadcrumbs" class="breadcrumbs">
                    <div class="breadcrumb-hero">
                        <div class="container">
                            <div class="breadcrumb-hero">
                                <h2>INPUT DATA JENIS SERVICE</h2>
                ...
                <section id="contact" class="contact">
                    <div class="container">
                        ...
                        <div class="col-lg-8 mt-5 mt-lg-0" data-aos="fade-left">
                            <a href="{{ route('admin.input3.showjenis') }}" class="btn btn-info">Detail data</a>
                            <form action="{{ route('admin.input3.createjenis.store') }}" method="post">
                                @csrf
                                ...
                                <div class="mt-4">
                                    <button type="submit" class="btn btn-dark">Input jenis service</button>
                                </div>
                            </form>
