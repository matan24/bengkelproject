...
@section('title', 'Data Service Konsumen | Bengkel Mobil')
      ...
      <section id="work-process" class="work-process">
        <div class="container">
          ...
          <div class="section-title" data-aos="fade-up">
            ...
            <p>Apabila data sudah banyak jangan lupa untuk mencetak data service konsumen setiap harinya</p>
          </div>
          
          <table class="table table-striped table-success table-bordered">
            <a href="{{ route('admin.input1.cetak') }}" target="blank" class="btn btn-primary mb-4">Cetak data konsumen <i class="fa-solid fa-print"></i></a>
            <thead>
