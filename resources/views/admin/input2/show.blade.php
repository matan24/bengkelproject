...
@section('title', 'Data Detail Jadwal Service | Bengkel Mobil')
...
<body>
 ...
 <section id="hero">
    <div class="hero-container" data-aos="fade-up"> 
      <h1>TIA BAN AUTO SERVICE</h1>
      <h2>Melayani | Service mobil | Ganti Ban</h2>
          ...
          <table class="table table-striped table-success table-bordered">
            ...
            <thead>
              ...
              <tr>
                ...
                <th scope="col">Pilih Kuota</th>
                <th scope="col">Jam Buka Service</th>
                <th scope="col">Kuota Konsumen Service</th>
            ...
            <tbody>
              ...
              <th scope="row">{{ $loop->iteration }}</th>
                ...
                <td>{{ $item->mekanik }}</td>
                 <td class="">
                  <a href="{{ route('admin.input2.editjadwal', $item->id) }}" class="btn btn-info mb-2"><i class="fa-solid fa-square-pen"></i></a>

                  <form action="{{ route('admin.input2.show.delete', $item->id) }}" method="post">
                    @method('delete')
                    @csrf 
