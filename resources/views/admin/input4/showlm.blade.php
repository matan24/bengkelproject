...
@section('title', 'Detail Laporan Mekanik Service | Bengkel Mobil')
      ...
      <section id="work-process" class="work-process">
        <div class="container">
          ...
          <div class="section-title" data-aos="fade-up">
            <h2>Laporan Mekanik Perhari</h2>
          </div>
          <a href="{{ route('admin.input4.createlm') }}" class="btn btn-info">Kembali</a>
          <br><br>
          <table class="table table-striped table-success table-bordered">
            ...
            <tbody>
              ...
              <th scope="row">{{ $loop->iteration }}</th>
                ...
                <td>{{ $item->status }}</td>
                 <td class="">
                  <a href="{{ route('admin.input4.editlm', $item->id) }}" class="btn btn-info mb-2"><i class="fa-solid fa-square-pen"></i></a>

                  <form action="{{ route('admin.input4.showlm.delete', $item->id) }}" method="post">
                     @method('delete')
                     @csrf 
